  ...
  render() {
    return (
      ...
      <form onSubmit={this.handleSubmit} style={{marginBottom: "35px"}}>
        <input type="text" className="zipCodeForm" style={{fontSize: "18px", fontFamily: "Source Sans Pro", fontWeight: "bold", color: "#b2b2b2", height: "64px", width: "204px", marginLeft: "7px"}} placeholder="Enter Zip Code" value={this.state.value} onChange={this.handleChange} />
